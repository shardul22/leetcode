 ...
 * Solution :-
 * 
 * 1) find length of both of the list.
 * 2) Calculate the difference of the length.
 * 3) Advance the head pointer of the list till the difference.
 * 4) Now check for the intersecting node and return the node
 * 
 * */
