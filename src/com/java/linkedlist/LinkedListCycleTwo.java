 ...
 * then fastNode and slowNode will collide with each other 3) Take the slowNode back to head node
 * and iterate till fastNode and slowNode collides with each other
 */
